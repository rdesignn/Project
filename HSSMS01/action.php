				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>$.$pro_price.00
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>CartService</button>
								</div>
							</div>
						</div>	
			";
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Service is already added into the cart Continue Adding..!</b>
				</div>
			";//not in video
		} else {
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="serviceadmin@business.com">
