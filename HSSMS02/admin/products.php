  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-primary btn-sm">Add Service</a>
      	</div>
      </div>
        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Service Keywords <small>(ISP, Electrician, HouseMaid)</small></label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Enter Product Keywords">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Servie Image <small>(format: jpg, jpeg, png)</small></label>
